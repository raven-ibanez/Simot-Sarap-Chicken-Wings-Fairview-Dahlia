      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 md:py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 animate-fade-in">
            ...
            <div className="relative overflow-hidden bg-yellow-400 text-red-800 rounded-full font-black text-sm md:text-base shadow-2xl border-4 border-white">
              <div className="flex animate-scroll">
                <div className="flex items-center gap-4 px-6 py-3 whitespace-nowrap">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-tight animate-bounce-gentle">
              <span className="inline-block animate-pulse">🔥</span> SIMOT SARAP
              <span className="block text-yellow-300 text-4xl md:text-6xl mt-2 animate-pulse">
                CHICKEN WINGS
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl text-orange-100 font-bold animate-fade-in" style={{ animationDelay: '0.2s' }}>
              🍗 Crispy, Juicy, Finger-Lickin' Good! 🍗
            </p>

            {/* Animated Promo Badges */}
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-xl border-4 border-yellow-300 animate-pulse hover:scale-110 transition-transform cursor-pointer">
                <div className="text-yellow-300 font-black text-3xl flex items-center gap-2">
                  <span className="animate-bounce">💰</span>
                  ₱109
                </div>
                <div className="text-white text-sm font-bold">Starting Price</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-xl border-4 border-yellow-300 animate-pulse hover:scale-110 transition-transform cursor-pointer" style={{ animationDelay: '0.2s' }}>
                <div className="text-yellow-300 font-black text-3xl flex items-center gap-2">
                  <span className="animate-bounce">🍗</span>
                  35+
                </div>
                <div className="text-white text-sm font-bold">Menu Items</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-xl border-4 border-yellow-300 animate-pulse hover:scale-110 transition-transform cursor-pointer" style={{ animationDelay: '0.4s' }}>
                <div className="text-yellow-300 font-black text-3xl flex items-center gap-2">
                  <span className="animate-spin">⭐</span>
                  4.8
                </div>
                <div className="text-white text-sm font-bold">Rating</div>
              </div>
            </div>
          </div>
